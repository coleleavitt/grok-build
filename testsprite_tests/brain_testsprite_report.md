...
#### Test TC001
- **Test Name:** Brain F008: Grok Build request path creates and recalls Brain records
- **Test Code:** [Brain_F008__Grok_Build_request_path_creates_and_recalls_Brain_records.py](./Brain_F008__Grok_Build_request_path_creates_and_recalls_Brain_records.py)
- **Status:** ✅ Passed
...
#### Test TC005
- **Test Name:** Brain F010: full Onyx Python Brain run/backfill parity
- **Test Code:** [Brain_F010__full_Onyx_Python_Brain_run_backfill_parity.py](./Brain_F010__full_Onyx_Python_Brain_run_backfill_parity.py)
- **Status:** ✅ Passed
- **Analysis / Findings:** Test passed. All assertions succeeded and the expected behavior was verified.
---
...
#### Test TC008
- **Test Name:** Brain F009: integration settings gate and deterministic self-improvement
- **Test Code:** [Brain_F009__integration_settings_gate_and_deterministic_self_improvement.py](./Brain_F009__integration_settings_gate_and_deterministic_self_improvement.py)
- **Status:** ✅ Passed
- **Analysis / Findings:** Test passed. All assertions succeeded and the expected behavior was verified.
---
...
- **31.71%** of tests passed

| Requirement | Total Tests | ✅ Passed | ❌ Failed |
|---|---|---|---|
| R001: Ungrouped | 41 | 13 | 28 |
| **Total** | 41 | 13 | 28 |
