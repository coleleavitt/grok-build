...
struct Inner {
    ...
    /// Single-flight for etag-triggered background refreshes.
...
impl ModelsManager {
    ...
    pub fn apply_config(&self, new_config: config::Config) {
        ...
        let new_catalog =
            resolve_model_catalog_with_providers(&new_config, prefetched, &plugin_providers);
    ...
    fn apply_catalog(
        ...
        let (first_real_catalog, excludes_all) = {
            ...
            cat.models = resolve_model_catalog_with_providers(
                cfg,
